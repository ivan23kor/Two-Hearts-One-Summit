...
define(['./workbox-e328c5da'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/\/src\/network\//, new workbox.NetworkFirst({
    "cacheName": "network-resources",
    "networkTimeoutSeconds": 3,
    plugins: []
  }), 'GET');
  workbox.registerRoute(/\/src\/game\//, new workbox.CacheFirst({
    "cacheName": "game-resources",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 50,
